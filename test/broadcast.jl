...
@testset "Issue #27911: Broadcasting over collections with large indices" begin
    @test iszero.(Int128(0):Int128(2)) == [true, false, false]
    @test iszero.((Int128(0):Int128(2)) .- 1) == [false, true, false]
    @test iszero.(float(0):float(2)) == [true, false, false]
    @test iszero.((float(0):float(2)) .- 1) == [false, true, false]
end
